...
if (!app.includes('new URL("./stockfish-worker.js",import.meta.url)')) throw new Error('same-origin Stockfish bootstrap missing');
if (!app.includes('base.search=`?engine=${encodeURIComponent(c.js)}&label=${encodeURIComponent(c.label)}`')) throw new Error('Stockfish engine query missing');
...
if (!version.includes('0.9.26')) throw new Error('version not bumped');
...
console.log('STOCKFISH 0.9.26 REGRESSION TESTS OK');
