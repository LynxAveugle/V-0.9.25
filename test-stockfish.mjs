...
assert.match(app,/new URL\("\.\/stockfish-worker\.js",import\.meta\.url\)/);
assert.match(app,/base\.search=`\?engine=\$\{encodeURIComponent\(c\.js\)\}&label=\$\{encodeURIComponent\(c\.label\)\}`/);
